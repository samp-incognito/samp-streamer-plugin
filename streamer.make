...
ifeq ($(config),release)
  ...
  DEFINES += -DBOOST_CHRONO_HEADER_ONLY -DBOOST_SYSTEM_NO_DEPRECATED -DNDEBUG -DSAMPGDK_AMALGAMATION
...
ifeq ($(config),debug)
  ...
  DEFINES += -DBOOST_CHRONO_HEADER_ONLY -DBOOST_SYSTEM_NO_DEPRECATED -DSAMPGDK_AMALGAMATION
  INCLUDES += -Iinclude -Ilib -Ilib/sdk
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
